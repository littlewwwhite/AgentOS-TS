...
GEMINI_API_KEY="..." python3 -X utf8 \
  "${CLAUDE_SKILL_DIR}/scripts/generate_style.py" \
...
```bash
GEMINI_API_KEY="..." python3 -X utf8 \
  "${CLAUDE_SKILL_DIR}/scripts/generate_prompts_from_script.py" \
  --script-json "../01-script/output/script.json" \
  --workspace "workspace" \
...
```bash
GEMINI_API_KEY="..." python3 -X utf8 \
  "${CLAUDE_SKILL_DIR}/scripts/generate_all_assets.py" \
  --script-json "../01-script/output/script.json" \
  --project-dir "output" \
  --workspace "workspace"
```
...
A: 直接运行对应的子脚本：
- 仅角色: `python ${CLAUDE_SKILL_DIR}/scripts/generate_characters.py --characters-json ...`
- 仅场景: `python ${CLAUDE_SKILL_DIR}/scripts/generate_scenes.py --scenes-json ...`
- 仅道具: `python ${CLAUDE_SKILL_DIR}/scripts/generate_props.py --props-json ...`
...
**脚本**: `${CLAUDE_SKILL_DIR}/scripts/generate_characters.py`

**关键参数**:
- `--skip-single-views`: 精简模式,只出三视图

**审核脚本**: `${CLAUDE_SKILL_DIR}/scripts/char_review.py`
- `front` 模式: 审查正视图
- `views` 模式: 审查侧/背视图一致性

### 场景生成器

**脚本**: `${CLAUDE_SKILL_DIR}/scripts/generate_scenes.py`

**审核脚本**:
- `${CLAUDE_SKILL_DIR}/scripts/scene_review.py`: 主图审核

### 道具生成器

**脚本**: `${CLAUDE_SKILL_DIR}/scripts/generate_props.py`

**审核脚本**: `${CLAUDE_SKILL_DIR}/scripts/props_review.py`
