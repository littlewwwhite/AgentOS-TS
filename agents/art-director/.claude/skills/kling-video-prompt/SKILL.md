...
| 文件 | 内容 |
|------|------|
| [`${CLAUDE_SKILL_DIR}/references/prompt-generation-rules.md`](${CLAUDE_SKILL_DIR}/references/prompt-generation-rules.md) | 完整提示词生成规则（元素清单、生成流程、质量检查） |
| [`${CLAUDE_SKILL_DIR}/references/prompts-format.md`](${CLAUDE_SKILL_DIR}/references/prompts-format.md) | Prompts 格式规范总结（字段格式、props 规则、检查工具） |
| [`${CLAUDE_SKILL_DIR}/references/visual-expansion.md`](${CLAUDE_SKILL_DIR}/references/visual-expansion.md) | 视觉描述扩展规则（动作/情绪扩展策略、标注规则） |
| [`${CLAUDE_SKILL_DIR}/references/video-download.md`](${CLAUDE_SKILL_DIR}/references/video-download.md) | 视频下载和目录组织规范 |
