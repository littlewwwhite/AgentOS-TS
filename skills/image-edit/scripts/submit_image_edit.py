...
# 自动从同目录的 auth.py 获取 token
sys.path.insert(0, os.path.dirname(__file__))
import auth as _auth


def main():
    parser = argparse.ArgumentParser(description="提交图片编辑任务")
    ...
    url = f"{args.base_url}/api/material/creation/imageEdit"
