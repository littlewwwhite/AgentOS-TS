...
first_mover: 情感推动力
core_style: A.虐心催泪流
style_guide_path: ntsv2-workspace/style-guide.md
anchor_path: ntsv2-workspace/anchor.md
five_invariants_locked: true
novel_highlights_count: 8
subplot_plan: 3条支线
completed:
  - S1-原文分析与灵感提取 → ntsv2-workspace/s1-analysis.md
  - S2-基础设定 → ntsv2-workspace/s2-setting.md
next_stage: S3-故事大纲
...
NTSV2 使用 `ntsv2-workspace/` 作为工作区根目录（区别于 SWS 的 `sws-workspace/`）：
