...
> Source: Anthropic official guide (PDF). Converted to Markdown for reference.
...
- Whitelist of MCP tools the skill can use
- Format: `mcp__servername__toolname`
- Claude will only use listed tools when the skill is active
